...
**Step 8. Implement cautiously.** Execute the sequenced actions, smallest blast radius first. Document the exact change (URL, before, after, date) so attribution is possible at step 9.

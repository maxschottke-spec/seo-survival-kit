...
## v0.5.1 (shipped as part of v0.5.2)

SISTRIX Monday Recovery Check ships as runnable skill. (No standalone v0.5.1 release was published; this scope landed in v0.5.2.)
